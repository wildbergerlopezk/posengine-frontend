...
"[project]/src/shared/utils/errorHandler.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function setupGlobalErrorHandlers() {
    ...
    ;
    const reportError = async (message, stack)=>{
        try {
            const user = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$store$2f$auth$2e$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"].getState().user;
            const userEmail = user ? `${user.name} (${user.email})` : "Invitado";
            await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/auth/report-frontend-error`, {
                method: "POST",
                headers: {
...
function ErrorInitializer() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ErrorInitializer.useEffect": ()=>{
            setupGlobalErrorHandlers();
        }
    }["ErrorInitializer.useEffect"], []);
    return null;
}
_s(ErrorInitializer, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = ErrorInitializer;
var _c;
__turbopack_context__.k.register(_c, "ErrorInitializer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_f408f795._.js.map