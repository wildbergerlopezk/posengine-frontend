...
"use client";
;
// Helper: solo true cuando corre dentro de Tauri
const isTauri = ()=>("TURBOPACK compile-time value", "object") !== 'undefined' && '__TAURI_INTERNALS__' in window;
function useAppUpdater() {
    ...
    const totalSize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(1);
    ...
    async function checkForUpdate() {
        if (!isTauri()) return;
        try {
            const { check } = await __turbopack_context__.A("[project]/node_modules/@tauri-apps/plugin-updater/dist-js/index.js [app-client] (ecmascript, async loader)"); // import dinámico
    ...
    async function installUpdate() {
        ...
        try {
            ...
            const { relaunch } = await __turbopack_context__.A("[project]/node_modules/@tauri-apps/plugin-process/dist-js/index.js [app-client] (ecmascript, async loader)");
            const update = await check();
...
//# sourceMappingURL=_e4022f55._.js.map